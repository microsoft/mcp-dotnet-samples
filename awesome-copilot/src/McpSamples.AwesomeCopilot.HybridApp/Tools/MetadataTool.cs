...
{
    /// <summary>
    /// Searches custom instructions based on keywords in their names and descriptions.
    /// </summary>
...
public class MetadataTool(IMetadataService service, ILogger<MetadataTool> logger) : IMetadataTool
{
    ...
    [Description("Searches agents, hooks, instructions, prompts, skills, and workflows based on keywords in their names and descriptions.")]
    ...
    [Description("Loads a custom instruction, agent, hook, prompt, skill, or workflow from the repository.")]
